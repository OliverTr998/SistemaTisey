...
SECRET_KEY = 'django-insecure-51ul)$#w)b*z^h7c5fh9h=$lla24)21rxyih&v$w1cle83u5+v'


# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True #'RENDER' not in os.environ

ALLOWED_HOSTS = ['sistematisey.onrender.com', '127.0.0.1', 'localhost']
# ALLOWED_HOSTS = []
...
INSTALLED_APPS = [
    ...
    'Apps.Catalogos.Empleado',
    'Apps.Catalogos.Persona',
    'Apps.Catalogos.Sexo',
    'Apps.Movimientos.Compra',
...
LOGGING = {
    ...
    'handlers': {
        ...
        'papertrail': {
            ...
            'address': ('logs3.papertrailapp.com', 25323),
        },
    },
    'root': {
